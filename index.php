                    ...
                    <section class="login_content">
                        <form action="action/login.php" method="post">
                            ...
                            <div class="separator">
                                ...
                                <br />
                                <div>
                                    <h1><i class="fa fa-ticket"></i> Help Desk - UMG</h1>
                                    <p> <a style="text-decoration: underline;" target="_blank" href="http://github.com/amnersaucedososa">Support</a>Universidad Mariano Galvez de Guatemala Privacy and Terms by <a target="_blank" style="text-decoration: underline;" href="http://github.com/amnersaucedososa">Grupo#3</a></p>
                                </div>
                            </div>
                        </form>
                    </section>
